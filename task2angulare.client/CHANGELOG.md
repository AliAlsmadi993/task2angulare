...
- Create Angular project with ng: `ng new task2angulare.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`task2angulare.client.esproj`).
